...
class Fruit(pygame.sprite.Sprite):
    ...
    def __init__(self, *groups, all_sprites, side_to_spawn, is_long, health=1, current_level, perfect_overlay_left, perfect_overlay_right, asset_loader, is_last_fruit=False, game_panel, start_fps):
        ...
        self.speed = self.distance_to_travel / start_fps
        self.length = 10
