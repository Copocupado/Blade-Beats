...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, current_fps, *args, **kwargs):
        ...
        self.input(0, left_fruit, area_hit=2 if perfect_left_fruit_collisions else 1, current_fps=current_fps)
        self.input(2, right_fruit, area_hit=2 if perfect_right_fruit_collisions else 1, current_fps=current_fps)

        self.frames_after_killing_fruit_left += 1
        self.frames_after_killing_fruit_right += 1
        self.player_hit_check()

    def input(self, side, fruit, area_hit, current_fps):
        ...
        if is_pressing_side:
            ...
            if cooldown < frames_after_killing_fruit:
                ...
                if fruit is not None:
                    ...
                    self.missed(current_fps=current_fps)
